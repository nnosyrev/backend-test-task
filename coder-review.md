...
- обкладывать код блоками try...catch и вызывать методы логирования тут не вижу смысла. в оригинальном коде так вообще было сделано по дурацки - в лог тупо писалось сообщение "Error". любое неперехваченное исключение должно логироваться на уровне фреймворка.
