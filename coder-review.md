...
- так же я бы не возвращал клиенту данных по товару из методов работы с корзиной. для получения данных товара по его Uuid, клиент должен будет дёргать другой методы API.
